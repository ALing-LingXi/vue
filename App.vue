	...
	<div class="container-fluid wraper">
		...
		<div class="row">
			<div class="col-xs-3 col-md-3 col-lg-3 col-xl-3">
				...
				<router-link active-class="active" class="list-group-item" to="/slot1">10. slot1</router-link>
				<router-link active-class="active" class="list-group-item" to="/slot2">11. slot2</router-link>
